...
public class Administrador extends Usuario{
    public Administrador(int id,String email, String nombre, String apellidos, String password, LocalDate fecha_nac, ROL rol){
        super(id,email,nombre,apellidos,password,fecha_nac,rol);
        this.validado=true;
    }
    
    public Administrador(String email, String nombre, String apellidos, String password, LocalDate fecha_nac, ROL rol){
